...
import { SourceMetadata, AnswerResponse, SessionConfig, ChatMessage } from '../types';
...
export const Workspace: React.FC<WorkspaceProps> = ({ source, onBack }) => {
  ...
  const handleAsk = async (e: React.FormEvent) => {
    ...
    try {
      const response = await api.askQuestion(userMsg.content, sessionConfig.apiKey, sessionConfig.model);
